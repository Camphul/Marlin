...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.31 //0.67    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #define C_XYZ_CURRENT 460
  #define C_Y_CURRENT 460
...
#define C_XY_MICROSTEPS 16
   ...
   * CHOPPER_PRUSAMK3_24V // Imported parameters from the official Průša firmware for MK3 (24V)  { 3, -2, 6 }
  ...
  #define CHOPPER_TMC2130V3 { 3, -1, 6 }
