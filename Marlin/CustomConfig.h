...
//#define C_SENSORLESS_XY_MIN_STALL
#define C_SENSORLESS_XY_MAX_STALL
...
#define C_JD_ACCELERATION_POW (C_DEFAULT_ACCELERATION * C_DEFAULT_ACCELERATION)
#define C_JD_JERK_SQUARED (C_JD_JERK * C_JD_JERK)
#define C_JD_FORMULA (C_JD_NOZZLE_DIA * C_JD_JERK_SQUARED / C_JD_ACCELERATION_POW)
