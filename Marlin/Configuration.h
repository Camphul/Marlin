...
#define STRING_CONFIG_H_AUTHOR "Luca Camphuisen" // Who made the changes.
...
#define Z_PROBE_SPEED_FAST C_Z_PROBE_SPEED_FAST

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST/ C_Z_PROBE_SPEED_SLOW_DIVISOR)
...
#define Y_MIN_POS 0//-2.5
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE//251
#define Y_MAX_POS X_BED_SIZE//245
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X C_GRID_POINTS_XY
  ...
  #define MESH_INSET C_MESH_INSET          // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X C_GRID_POINTS_XY    // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 *  1. Print a test square (e.g., https://www.thingiverse.com/thing:2563185)q
