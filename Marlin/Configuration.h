 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400,/*126*/126/*93*//*104*/ }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 400, 400, 20, 5000 }
 ...
 */
  ...
  #define C_JD_FORMULA (C_NOZZLE_DIAMETER * C_JD_JERK * C_JD_JERK / DEFAULT_ACCELERATION)
  //Final junction deviation value
  #define JUNCTION_DEVIATION_MM C_JD_FORMULA // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.6, -6, /*-2.175, -2.225*/ /*-2.36*/ -1.7800}
